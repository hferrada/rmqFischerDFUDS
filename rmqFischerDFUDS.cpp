...
double runExperimentTimeRMQ(DFUDSrmq *rmq, ulong n);
...
int testRMQLoad(int argc, char *argv[]) {
	...
	strcpy(file, argv[1]);
	DFUDSrmq *rmq = new DFUDSrmq(file);
